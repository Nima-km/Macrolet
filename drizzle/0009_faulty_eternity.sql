...
CREATE TABLE `__new_foodItem` (
	...
	`timestamp1` integer DEFAULT (current_timestamp) NOT NULL,
...
INSERT INTO `__new_foodItem`("id", "timestamp1", "food_id", "servings", "meal") SELECT "id", "timestamp1", "food_id", "servings", "meal" FROM `foodItem`;--> statement-breakpoint
